...
class _PhotoProgressWidgetState extends State<PhotoProgressWidget> {
  ...
  Future<void> _takePhoto() async {
    try {
      ...
      _toast('Falha ao abrir a câmera.');
    }
  }
  ...
  Future<void> _selectFromGallery() async {
    try {
      ...
      _toast('Falha ao abrir a galeria.');
    }
  }
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              image: _imageProviderFor(_progressPhotos.first),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(12),
                            image: DecorationImage(
                              image: _imageProviderFor(_progressPhotos.last),
                              fit: BoxFit.cover,
                            ),
                          ),
                        ),
