    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 2.h),
          _FormInputWidget(controller: _fatController, focusNode: _fatFocus, label: 'Gordura', suffix: 'g', icon: Icons.oil_barrel_outlined, isOptional: true, onEditComplete: () => FocusScope.of(context).requestFocus(_portionFocus)),
          SizedBox(height: 2.h),
