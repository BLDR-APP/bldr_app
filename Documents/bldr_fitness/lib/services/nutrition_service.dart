  ...
  Future<Map<String, dynamic>> createOrUpdateUserFoodItem({
    ...
    try {
      final response = await _client.from('food_items').insert({
        'user_id': currentUser.id, 'name': name, 'serving_description': servingDescription,
        ...
        'is_verified': false, 'calories_per_100g': null, 'protein_per_100g': null, 'carbs_per_100g': null, 'fat_per_100g': null,
      }).select().single();
      return response;
